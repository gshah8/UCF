...
def parse_args():
    ...
    parser.add_argument('--cfg', type=str, default='config/yolov3_default_test1.cfg',
                        help='config file. see readme')
    #parser.add_argument('--weights_path', type=str,
    #                    default='C:\Users\ma121036\Desktop\vision\new code\PyTorch_YOLOv3-master\requirements', help='darknet weights file')
    parser.add_argument('--weights_path', type=str,
    ...
    parser.add_argument('--eval_interval', type=int,
                            default=2000, help='interval between evaluations')
    ...
    parser.add_argument(
        '--tfboard', help='tensorboard path for logging', type=str, default="logstb")
